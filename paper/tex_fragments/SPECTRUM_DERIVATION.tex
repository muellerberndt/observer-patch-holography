...
\(Z\) pole & 91.220 & 91.188 ± 0.002 & +0.035\% & §4 & Uses simplified \(\Delta\rho = 3/(32\pi^2)\). Full EW treatment absorbs most of this offset \\
\(H\) (Higgs) & 126.48 & 125.20 ± 0.11 & +1.02\% & §5 & Uses 1-loop SM RGE only. Missing 2-loop terms can shift \(m_H\) downward by about 1 GeV; result is also sensitive to \(M_U\) \\
\end{longtable}
}
