...
SM 1-loop \(\beta\)-coefficients & \((b_1, b_2, b_3)^{\text{SM}} = (41/10, -19/6, -7)\) & \texttt{B\_\allowbreak SM\_\allowbreak 1LOOP} & Standard 1-loop coefficients for the SM with \(N_g = 3\), used only for the critical-surface RG evolution from \(M_U\) to \(m_t\) (§5 of this paper). Determined entirely by the SM gauge group and matter content. \\
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}>{\RaggedRight\arraybackslash}p{0.192\textwidth}>{\RaggedLeft\arraybackslash}p{0.192\textwidth}>{\RaggedLeft\arraybackslash}p{0.192\textwidth}>{\RaggedLeft\arraybackslash}p{0.192\textwidth}>{\RaggedRight\arraybackslash}p{0.192\textwidth}@{}}
\toprule\noalign{}
