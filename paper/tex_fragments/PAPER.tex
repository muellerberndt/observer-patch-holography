...
\item
  The commutant of \(SU(3) \times SU(2)\) inside \(U(6)\) is exactly \(U(1)\), so no additional continuous factors appear without increasing \(\chi_{\mathrm{cpl}}\).
\item
