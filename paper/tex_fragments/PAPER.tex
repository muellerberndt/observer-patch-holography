...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}>{\RaggedLeft\arraybackslash}p{0.120\textwidth}@{}}
\toprule\noalign{}
