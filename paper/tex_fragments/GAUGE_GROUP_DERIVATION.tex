...
\textbf{From:} Lemmas 6.3--6.5 of Part I of this manuscript, applied to the minimal coupled carrier.
...
\textbf{Proposition 5.7 (No additional factors).} No extra gauge factor , neither nonabelian nor abelian , can appear without increasing \(\chi_{\mathrm{cpl}}\) beyond 6.
...
\textbf{Corollary.} The SM gauge group is the \emph{unique} solution. No other compact gauge group satisfies all admissibility conditions while achieving \(\chi_{\mathrm{cpl}} = 6\).
